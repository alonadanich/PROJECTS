...
model += limonade + fruit_juice, "Total_Products"
...
print("Кількість лимонаду:", int(limonade.varValue))
print("Кількість фруктового соку:", int(fruit_juice.varValue))
print("Загальна кількість продуктів:", int(pulp.value(model.objective)))